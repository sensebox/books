...
Bei der Variante mit dem USB Kabel muss mit Hilfe eines Multimeters die passenden Vcc und GND Leitungen ermittelt werden.
...
Der Arduino Uno oder Nano hat leider keinen Sleep Modus, kann aber durch die [Narcoleptic Libray](https://github.com/doc62/narcoleptic) zu einem geringeren Stromverbrauch angeregt werden. Diese deaktiviert alle unnötigen Vorgänge des Arduino.
